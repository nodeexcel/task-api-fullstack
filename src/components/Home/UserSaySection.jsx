...
const UserSaySection = () => {
  return (
    ...
    >
      ...
      <div
        id="review"
        className="text-light d-flex justify-content-center fs-1 mt-5"
      >
        What our users say <TbMessageCircle />
      </div>
      <div
        className="d-flex justify-content-center fs-md-4 fs-sm-6 mb-5"
      ...
      <div className={`d-flex ${styles.RightScroll}`}>
        <RightScroll />
        <RightScroll />
      </div>
    </div>
